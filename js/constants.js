...
const DECK_CARD_CONTAINER = 'table-card deck__back-card';
const KOZYR_CARD_CONTAINER = 'table-card deck__kozyr';
const TRASH_CARD_CONTAINER = 'table-card trash__back-card';
const COUNTER_CONTAINER = 'deck__card-counter';
